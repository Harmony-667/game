...
enum class RockType(
    ...
    CLAY(
        ...
        lowChance = 128,
        highChance = 392,
        objectIds = arrayOf(Objs.ROCKS_15504, Objs.ROCKS_15503, Objs.ROCKS_15505, Objs.ROCKS_5766, Objs.ROCKS_5767, Objs.ROCKS_10578, Objs.ROCKS_10577)
    ),
    COPPER(
        level = 1,
        experience = 17.5,
    ...
    TIN(
        ...
        objectIds = arrayOf(Objs.ROCKS_3038, Objs.ROCKS_3245, Objs.ROCKS_11933, Objs.ROCKS_11959, Objs.ROCKS_11957,
            ...
            Objs.ROCKS_11934, Objs.ROCKS_11935)
    ),
    BLURITE(
        level = 10,
        experience = 17.5,
